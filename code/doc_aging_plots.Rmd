...
```{r}
png(filename="returns_age_num.png", width=600, height=400)
ggplot(data=returns_only) + 
  geom_line(aes(x=year, y=num_50_over, colour="all ages 50+")) +
  geom_line(aes(x=year, y=(age16_18+age19_20), colour="20 and under")) +
  geom_line(aes(x=year, y=(age21_24+age25_29), colour="21-29")) +
  geom_line(aes(x=year, y=(age30_34), colour="30-34")) +
  geom_line(aes(x=year, y=(age35_39), colour="35-39")) +
  geom_line(aes(x=year, y=(age40_44+age45_49), colour="40-49")) +
  scale_x_continuous(n.breaks=9) + labs(title="NYS Returns within 3 years post (2011-2021)", 
                                        subtitle="Reported by the DOCCS annual inmate releases report.",
                                        x="Year released",
                                        y="Individuals returned (number)",
...
png(filename="returns_age_prop.png", width=600, height=400)
ggplot(data=returns_only) + 
  geom_line(aes(x=year, y=num_50_over/year_total, colour="all ages 50+")) +
  geom_line(aes(x=year, y=(age16_18+age19_20)/year_total, colour="20 and under")) +
  geom_line(aes(x=year, y=(age21_24+age25_29)/year_total, colour="21-29")) +
  geom_line(aes(x=year, y=(age30_34)/year_total, colour="30-34")) +
  geom_line(aes(x=year, y=(age35_39)/year_total, colour="35-39")) +
  geom_line(aes(x=year, y=(age40_44+age45_49)/year_total, colour="40-49")) +
  scale_x_continuous(n.breaks=9) + scale_y_continuous(labels=scales::percent) +labs(title="NYS Returns within 3 years post (2011-2021)", 
                                        subtitle="Reported by the DOCCS annual inmate releases report.",
                                        x="Year released",
                                        y="Individuals returned (proportion)",
                                        color="Age group by decades") + theme_nycc()
dev.off()
```
...
```{r}
state_app <- read.csv("state_approxcommits.csv")
head(state_app)
```
